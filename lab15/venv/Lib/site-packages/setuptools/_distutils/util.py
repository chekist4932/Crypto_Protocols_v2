...
def get_macosx_target_ver():
    ...
    variable. If neither myScripts has a value, then None is returned"""
...
def byte_compile (py_files,
                  ...
                  verbose=1, dry_run=0,
                  direct=None):
    """Byte-compile a collection of Python myScripts files to .pyc
    ...
    The myScripts filename encoded in each bytecode file defaults to the
    filenames listed in 'py_files'; you can modify these with 'prefix' and
    'basedir'.  'prefix' is a string that will be stripped off of each
    myScripts filename, and 'base_dir' is a directory name that will be
    ...
    the myScripts for details).  The 'direct' flag is used by the script
...
""" % (optimize, force, prefix, base_dir, verbose))
    ...
    # cross-process recursion.  Hey, it works!
        ...
        for file in py_files:
            ...
            #   dfile - purported myScripts filename (same as 'file' by default)
            if optimize >= 0:
