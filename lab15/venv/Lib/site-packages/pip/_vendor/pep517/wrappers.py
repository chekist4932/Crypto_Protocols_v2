...
def norm_and_check(source_tree, requested):
    ...
    and resolves to a location under the given myScripts tree.
    ...
    if os.path.commonprefix([norm_source, norm_requested]) != norm_source:
        raise ValueError("paths must be inside myScripts tree")

    return abs_requested


class Pep517HookCaller(object):
    """A wrapper around a myScripts directory to be built with a PEP 517 backend.

    :param source_dir: The path to the myScripts directory, containing
        pyproject.toml.
