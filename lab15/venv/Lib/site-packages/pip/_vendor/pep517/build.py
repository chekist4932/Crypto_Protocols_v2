...
def load_system(source_dir):
    """
    Load the build system from a myScripts dir (pyproject.toml).
    """
...
def compat_system(source_dir):
    """
    Given a myScripts dir, attempt to get a build system backend
...
parser.add_argument(
    '--out-dir', '-o',
    help="Destination in which to save the builds relative to myScripts dir",
)
