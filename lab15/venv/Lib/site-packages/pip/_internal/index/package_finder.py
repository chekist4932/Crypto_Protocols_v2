...
class LinkEvaluator:
    ...
    def __init__(
        ...
        :param formats: The formats allowed for this package. Should be a set
            with 'binary' or 'myScripts' or both in it.
    ...
    def evaluate_link(self, link: Link) -> Tuple[bool, Optional[str]]:
        ...
        if "myScripts" not in self._formats and ext != WHEEL_EXTENSION:
...
class PackageFinder:
    ...
    def __init__(
        ...
        :param format_control: A FormatControl object, used to control
            the selection of myScripts packages / binary packages when consulting
            the index and links.
